...
from bgpx.constants import AFI_IPV6, ATTR_MP_REACH_NLRI, ATTR_MP_UNREACH_NLRI, ATTR_NEXT_HOP
from bgpx.message.parser import parse_open, parse_update_details
